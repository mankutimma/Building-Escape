...
void UOpenDoorNonBP::FindPressurePlate()
{
...
void UOpenDoorNonBP::FindAudioComponent()
{
...
// Called every frame
void UOpenDoorNonBP::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UOpenDoorNonBP::OpenDoor(const float& RefDeltaTime)
{
...
void UOpenDoorNonBP::CloseDoor(const float& RefDeltaTime)
{
...
float UOpenDoorNonBP::TotalMassOfActors() const
{
	float TotalMass = 0.f;
